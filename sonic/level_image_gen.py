...
class LevelImageGen:
    ...
    def load_sprites(self, sprite_path):
        ...
        sheets = {
            "sonic": [Image.open(os.path.join(sprite_path, r"sonic\Sonic.png")).convert("RGBA")],

            "enemies": [Image.open(os.path.join(sprite_path, r"enemies\buzz_bomber.png")).convert("RGBA"),
                        Image.open(os.path.join(sprite_path, r"enemies\enemycube_face_1.png")).convert("RGBA"),
                        Image.open(os.path.join(sprite_path, r"enemies\enemycube_face_2.png")).convert("RGBA"),
                        Image.open(os.path.join(sprite_path, r"enemies\enemycube_face_3.png")).convert("RGBA"),
                        Image.open(os.path.join(sprite_path, r"enemies\Traps.png")).convert("RGBA"),
                        ],

            "snail": [Image.open(os.path.join(sprite_path, r"enemies\snails.png")).convert("RGBA")],

            "trap": [Image.open(os.path.join(sprite_path, r"enemies\Traps.png")).convert("RGBA")],

            "floor": [Image.open(os.path.join(sprite_path, r"floor\floor_1.png")), 
                      Image.open(os.path.join(sprite_path, r"floor\floor_2.png"))],

            "flower":[Image.open(os.path.join(sprite_path, r"flower\flower_body.png")), 
            ...
            "ground_block":[Image.open(os.path.join(sprite_path, r"ground_block\ground_block_bl.png")),
                           Image.open(os.path.join(sprite_path, r"ground_block\ground_block_bm.png")),
                           Image.open(os.path.join(sprite_path, r"ground_block\ground_block_br.png")),
                           Image.open(os.path.join(sprite_path, r"ground_block\ground_block_ml.png")),
                           Image.open(os.path.join(sprite_path, r"ground_block\ground_block_mm.png")),
                           Image.open(os.path.join(sprite_path, r"ground_block\ground_block_mr.png")),
                           Image.open(os.path.join(sprite_path, r"ground_block\ground_block_tr.png")),
                           Image.open(os.path.join(sprite_path, r"ground_block\ground_block_tl.png")),
                           Image.open(os.path.join(sprite_path, r"ground_block\ground_block_tm.png"))],

            "curved_ground": [ 
            Image.open(os.path.join(sprite_path, r"curved_ground\curved_ground_tr.png")),
            Image.open(os.path.join(sprite_path, r"curved_ground\curved_ground_tm.png")), 
            Image.open(os.path.join(sprite_path, r"curved_ground\curved_ground_br.png")),
            Image.open(os.path.join(sprite_path, r"curved_ground\curved_ground_bm.png")),
            Image.open(os.path.join(sprite_path, r"curved_ground\curved_ground_bl.png"))],
            
            "stage_block": [Image.open(os.path.join(sprite_path, r"stage_block\stage_block_l.png")),
                            Image.open(os.path.join(sprite_path, r"stage_block\stage_block_mid.png")),
            ...
            "tree": [Image.open(os.path.join(sprite_path, r"tree\tree_bm.png")),
            ...
            "Goalpost": [Image.open(os.path.join(sprite_path, r"goalpost\Goalpost.png"))],

            "background": [Image.open(os.path.join(sprite_path, r"background\tiled_background.png")), 
                           Image.open(os.path.join(sprite_path, r"background\background.jpg"))],
        }

        sprite_dict = {
            "Sonic": sheets["sonic"][0].crop((0, 0, 40, 40)).resize((32, 32)).convert("RGBA"),

            "ground_block_bl": sheets["ground_block"][0].resize((32, 32)).convert("RGBA"),
            "ground_block_bm": sheets["ground_block"][1].resize((32, 32)).convert("RGBA"),
            "ground_block_br": sheets["ground_block"][2].resize((32, 32)).convert("RGBA"),
            "ground_block_ml": sheets["ground_block"][3].resize((32, 32)).convert("RGBA"),
            "ground_block_mm": sheets["ground_block"][4].resize((32, 32)).convert("RGBA"),
            "ground_block_mr": sheets["ground_block"][5].resize((32, 32)).convert("RGBA"),
            "ground_block_tr": sheets["ground_block"][6].resize((32, 32)).convert("RGBA"),
            "ground_block_tl": sheets["ground_block"][7].resize((32, 32)).convert("RGBA"),
            "ground_block_tm": sheets["ground_block"][8].resize((32, 32)).convert("RGBA"),
            ...
            "curved_ground_tr": sheets["curved_ground"][0].resize((32, 32)).convert("RGBA"),
            "curved_ground_tm": sheets["curved_ground"][1].resize((32, 32)).convert("RGBA"),
            "curved_ground_br": sheets["curved_ground"][2].resize((32, 32)).convert("RGBA"),
            "curved_ground_bm": sheets["curved_ground"][3].resize((32, 32)).convert("RGBA"),
            "curved_ground_bl": sheets["curved_ground"][4].resize((32, 32)).convert("RGBA"),
            ...
            "trap": sheets["enemies"][4].crop((0, 0, 50, 50)).resize((32, 32)).convert("RGBA"),
            ...
            "ring": sheets["ring"][0].crop((0, 0, 50, 50)).resize((32, 32)).convert("RGBA"),
           ...
           "background_1": sheets["background"][0].resize((32, 32)).convert("RGBA"),
            "background_2": sheets["background"][1].crop((425, 196, 468, 224)).resize((32, 32)).convert("RGBA"),

            "Goal Post": sheets["Goalpost"][0].crop((0, 0, 50, 50)).resize((32, 32)).convert("RGBA"),
        }

        return sprite_dict

    def prepare_sprite_and_box(self, ascii_level, sprite_key, curr_x, curr_y):
        """Prepares the sprite and the box for pasting in the level image."""
        ...
        def has_three_ground_blocks_below(ascii_level, curr_x, curr_y):
            ...
            return (curr_x - 1 >= 0 and row_below[curr_x - 1] == "#" and
                    row_below[curr_x] == "#" and
                    curr_x + 1 < len(row_below) and row_below[curr_x + 1] == "#")
        ...
        if sprite_key not in ["#", "&", "F", "f", "|", "P", "O", "B", "^", "-", "@", "/"]:
            return None, None
        ...
        # Handling sorite depending on their type and logical problems
            ...
            elif curr_x == len(ascii_level[curr_y]) - 1 or ascii_level[curr_y][curr_x+1] != "#":
            ...
            if (curr_y + 1 < len(ascii_level)) and (ascii_level[curr_y + 1][curr_x] in ["#", "&"]):
            ...
            if (curr_y > 0 and ascii_level[curr_y-1][curr_x] in ["#", "&"]) or \
            (curr_y < len(ascii_level) - 1 and ascii_level[curr_y+1][curr_x] in ["#", "&"]) or \
            (curr_x > 0 and ascii_level[curr_y][curr_x-1] in ["#", "&"]) or \
            (curr_x < len(ascii_level[curr_y]) - 1 and ascii_level[curr_y][curr_x+1] in ["#", "&"]):

                if ascii_level[curr_y-1][curr_x] == "#" or ascii_level[curr_y-1][curr_x] == "&":
            ...
            if (curr_y + 1 < len(ascii_level)) and (ascii_level[curr_y + 1][curr_x] in ["#", "&"]):
                ...
                if curr_y - 1 >= 0 and ascii_level[curr_y - 1][curr_x] == "-":
                    ...
                    sprite = sprite.resize((b_multiplier, b_multiplier))  # Resize to the appropriate size
            ...
            if has_three_ground_blocks_below(ascii_level, curr_x, curr_y):
                ...
                sprite = self.sprite_dict["background_1"].resize((b_multiplier, b_multiplier))          
    ...
    def render(self, ascii_level):
        ...
        background = self.sprite_dict["background_1"].resize((b_multiplier, b_multiplier))
        for y in range(height_level):
            for x in range(len_level):
                dst.paste(background, (x * b_multiplier, y * b_multiplier, (x + 1) * b_multiplier, (y + 1) * b_multiplier))
        ...
        for y, row in enumerate(ascii_level):
            for x, char in enumerate(row):
                sprite_key = char
                if sprite_key:
                    sprite, box = self.prepare_sprite_and_box(ascii_level, sprite_key, x, y)
                    if sprite and box:
                        dst.paste(sprite, box, mask=sprite)  # Use sprite as its own mask
