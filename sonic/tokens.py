...
TOKENS = OrderedDict(
    {**GROUND_TOKENS, **SPECIAL_GROUND_TOKENS, **SKY_TOKENS, **ENEMY_TOKENS, **SPECIAL_TOKENS, **EXTRA_SPECIAL_TOKENS}
)

TOKENS_GROUPS = [SKY_TOKENS, GROUND_TOKENS, SPECIAL_GROUND_TOKENS, ENEMY_TOKENS, SPECIAL_TOKENS, EXTRA_SPECIAL_TOKENS]
