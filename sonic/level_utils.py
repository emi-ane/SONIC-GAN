...
from sonic.tokens import TOKENS_GROUPS, REPLACE_TOKENS
...
def place_a_sonic_token(level):
    """ Finds the first plausible spot to place Sonic on. Especially important for levels with floating platforms.
