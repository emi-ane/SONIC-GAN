...
from games.sonic_commercial.tokens import TOKEN_DOWNSAMPLING_HIERARCHY as HIERARCHY


def special_sonic_commercial_downsampling(num_scales, scales, image, token_list):
    """
