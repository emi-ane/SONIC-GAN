...
from games.mario.level_utils import load_level_from_text
from games.sonic_commercial.level_image_gen import LevelImageGen

# Renders all level.txt files to png images inside a given folder. Expects ONLY .txt in that folder.

SPRITE_PATH = "games/sonic/sprites"

if __name__ == "__main__":
    ImgGen = LevelImageGen(SPRITE_PATH)

    directory = "/input/sonic/"
    ...
    target_dir = "/output/sonic_level_images/"  # + curr_gen
